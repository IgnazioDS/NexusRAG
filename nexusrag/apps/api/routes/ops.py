...
async def ops_operability(
    ...
    payload = {
        ...
        "deliveries_queued": queue["deliveries_queued"],
        "deliveries_delivering": queue["deliveries_delivering"],
        "deliveries_retrying": queue["deliveries_retrying"],
        "deliveries_dlq": queue["deliveries_dlq"],
        "deliveries_delivered_last_15m": queue["deliveries_delivered_last_15m"],
        "success_rate_15m": queue["success_rate_15m"],
        "p50_delivery_latency_ms": queue["p50_delivery_latency_ms"],
        "p95_delivery_latency_ms": queue["p95_delivery_latency_ms"],
