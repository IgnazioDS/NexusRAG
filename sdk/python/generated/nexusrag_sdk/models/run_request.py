...
class RunRequest(BaseModel):
    ...
    corpus_id: StrictStr
    message: StrictStr
    top_k: Optional[Annotated[int, Field(le=50, strict=True, ge=1)]] = 5
    audio: Optional[StrictBool] = False
    __properties: ClassVar[List[str]] = ["session_id", "corpus_id", "message", "top_k", "audio"]
