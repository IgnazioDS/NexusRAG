...
class SuccessEnvelopeListPlanResponse(BaseModel):
    """
    SuccessEnvelopeListPlanResponse
    """ # noqa: E501
    data: List[NexusragAppsApiRoutesAdminPlanResponse]
    meta: ResponseMeta
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "data": [NexusragAppsApiRoutesAdminPlanResponse.from_dict(_item) for _item in obj["data"]] if obj.get("data") is not None else None,
