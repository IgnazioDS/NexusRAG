...
export function connectRunStream(options) {
    const { baseUrl, apiKey, body, onEvent, onError, onDone, heartbeatTimeoutMs = 20000, maxRetries = 3, initialRetryMs = 500, } = options;
    let aborted = false;
    let lastSeq = null;
